...
1. Jeżeli wartość _irradiance_ jest niezerowa, należy ją zostawić w spokoju.
2. Jeżeli wartosć _irradiance_ jest zerowa, należy wyliczyć średnią dla danego czujnika w ciągu danego roku i miesiąca, a następnie umieścić ją w atrybucie _irradiance_.
